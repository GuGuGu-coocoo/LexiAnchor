...
const english = {
  ...
  dictionaryInstalled: 'The English–French dictionary was installed on this device.',
  removeDictionary: 'Remove',
  removeDictionaryConfirm: 'Remove the downloaded English–French dictionary from this device?',
  dictionaryRemoved: 'The English–French dictionary was removed.',
...
const simplifiedChinese: Record<MessageKey, string> = {
  ...
  dictionaryInstalled: '英法词典已安装到本机。',
  removeDictionary: '移除',
  removeDictionaryConfirm: '从本机移除已下载的英法词典？',
  dictionaryRemoved: '英法词典已移除。',
...
const french: Record<MessageKey, string> = {
  ...
  dictionaryInstalled: 'Le dictionnaire anglais–français a été installé sur cet appareil.',
  removeDictionary: 'Supprimer',
  removeDictionaryConfirm:
    'Supprimer le dictionnaire anglais–français téléchargé de cet appareil ?',
  dictionaryRemoved: 'Le dictionnaire anglais–français a été supprimé.',
  dictionaryDownloadNote:
