...
export const migrations: readonly Migration[] = [
  ...
  },
  {
    version: 6,
    sql: `
      DROP TRIGGER IF EXISTS word_cards_fts_after_insert;
      DROP TRIGGER IF EXISTS word_cards_fts_after_delete;
      DROP TRIGGER IF EXISTS word_cards_fts_after_update;
      DROP TABLE IF EXISTS word_cards_fts;
      ...
      INSERT INTO word_cards_fts(
        rowid, term, definition, definitions_json, root_or_etymology,
        source_book_title, source_sentence
      )
      SELECT
        rowid, term, definition, definitions_json, root_or_etymology,
      ...
      BEGIN
        INSERT INTO word_cards_fts(
          ...
          new.rowid, new.term, new.definition, new.definitions_json, new.root_or_etymology,
          new.source_book_title, new.source_sentence
        );
      END;
      ...
      BEGIN
        INSERT INTO word_cards_fts(
          word_cards_fts, rowid, term, definition, definitions_json, root_or_etymology,
          source_book_title, source_sentence
        ) VALUES (
          'delete', old.rowid, old.term, old.definition, old.definitions_json,
          old.root_or_etymology, old.source_book_title, old.source_sentence
        );
      END;
